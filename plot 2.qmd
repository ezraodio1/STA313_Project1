...
#| label: plot2a_valence_energy_change_over_time
...
#|   with the rest of the plot show that there is a slight decrease, but seemingly insignificant,
#|   decrease in both energy and valence scores of her albums over time.
