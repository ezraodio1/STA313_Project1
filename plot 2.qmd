...
taylor_albums_plot2a <- taylor_albums_plot2a |>
  ...
  mutate(
    ...
    album_name = factor(album_name, levels = c("Midnights",  "evermore", "folklore",
                                                    "Lover", "reputation", "1989", 
                                                    "Red", "Speak Now", 
                                                    "Fearless (Taylor's Version)", 
                                                    "Fearless", "Taylor Swift", "The Taylor Swift Holiday Collection",
...
ggplot(taylor_albums_plot2a, aes(x = album_release)) +
  ...
  facet_wrap(~song_attribute, ncol = 1, labeller = labeller(song_attribute = c(energy = "Attribute: Energy", 
                                                                               valence = "Attribute: Valence")))
