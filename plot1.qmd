...
taylor_albums_data <- taylor_albums_data |>
  mutate(album_name = factor(album_name, levels = c("Midnights",  "evermore", "folklore",
...
ggplot(taylor_albums_data, aes(x = song_type, y = energy, color = song_type)) +
  geom_boxplot(show.legend = FALSE) +
  scale_color_manual(values = c("#4D4D4D", "#DEA9C9")) +
  theme_bw() +
  labs(
    title = "Tempo Distribution of Taylor Swift Songs",
    subtitle = "Album only songs versus single releases",
    x = "Release Type",
    y = "Tempo",
    caption = "Source: Tidy Tuesday Data"
  )
